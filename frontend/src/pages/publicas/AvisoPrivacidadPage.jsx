...
const AvisoPrivacidadPage = () => {
  ...
  // Separar la sección específica del rol (índice 2 después del splice) del resto
  const seccionRol = doc.contenido[2]
  const seccionesComunes = doc.contenido.filter((_, i) => i !== 2)
    ...
    <div style={s.page}>
      ...
      <main style={s.main}>
        ...
        <div style={s.hero}>
          ...
          <h1 style={s.heroTitulo}>Aviso de Privacidad</h1>
          <p style={s.heroSub}>Conoce cómo tratamos tus datos personales según tu rol en la plataforma.</p>
        </div>
